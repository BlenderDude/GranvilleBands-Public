                                ...
                                >
                                    ...
                                    <View style={{
                                        ...
                                        <ScrollView
                                            ...
                                            ref="step">
                                            <CurrentPhotos
                                                newPhoto={this._addPhoto.bind(this)}
            ...
            RNPhotosFramework.requestAuthorization().then((status) => {
                if (status.isAuthorized) {
                    RNPhotosFramework.getAssets({
                        ...
                        prepareForSizeDisplay: '5000|500',
                        fetchOptions: {
                            mediaTypes: ["image"],
                        ...
                        this.setState({
                            ...
                            includesLastAsset,
                            endIndex: this.state.endIndex + this.PHOTOS_PER_FETCHED,
                            loading: false,
                        });
                    });
                }
...
class CameraRollPhoto extends Component {
    ...
    render() {
        console.log(this.props.photo.image)
        return (
            <TouchableWithoutFeedback
                ...
                <Image
                    ...
                    style={{
                        ...
                        width: this.props.size,
                        height: this.props.size,
                        opacity: this.state.inUpload ? 0.2 : 1
                    }}
                />
